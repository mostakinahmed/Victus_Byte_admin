      ...
      <div className="px-2 md:px-0 mt-3">
        ...
        >
          <div className="lg:flex">
            ...
            <div className="lg:w-[600px] border-r border-slate-200 p-3 space-y-2">
              ...
              <div className="space-y-6">
                ...
                {/* 2. Pricing & Category */}
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-2 flex bg-emerald-50 gap-3 rounded border border-emerald-200">
                    <label className="w-2/3 text-[12px] flex justify-center items-center font-medium text-emerald-600  tracking-widest">
                      Selling Price
                    </label>
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      <input
                        type="number"
                        className="w-full bg-transparent text-xl font-medium text-emerald-900 outline-none"
                ...
                <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200">
                  <label className="text-[12px] font-medium text-slate-600 uppercase tracking-widest ml-1">
                    Search Keywords (SEO)
                  </label>
                  <div className="flex gap-2 mb-4">
                    ...
                    <button
                      ...
                      className="bg-slate-900 cursor-pointer text-white px-5 rounded-xl font-bold text-xs uppercase"
                    >
                      Add
                    </button>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {formData.keywords.map((tag, i) => (
                      <span
                        key={i}
                        className="px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-700 flex items-center gap-2"
                      >
                        {tag}{" "}
                        <FiX
                ...
                <div className="bg-slate-50 p-3 rounded border border-slate-200">
                  ...
                  <div className="flex gap-2 mb-4">
                    ...
                    <button
                      ...
                      className="bg-emerald-600 cursor-pointer text-white px-5 rounded-xl font-bold text-xs uppercase"
                    >
                      Add
                    </button>
                  </div>
                  <div className="flex flex-wrap gap-3">
                    {formData.colors.map((color, i) => (
                      <span
                        key={i}
                        className="px-3 py-1.5 bg-emerald-50 border border-emerald-200 rounded-lg text-sm font-medium text-emerald-800 flex items-center gap-2"
                      >
                        <div
            ...
            <div className="flex-1 p-3 bg-slate-50/50">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  className="bg-indigo-600 text-white px-6 py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest cursor-pointer hover:bg-indigo-700 transition-all"
                >
                  + Add Spec Section
                </button>
              </div>
                ...
                {customSpecs.map((group, gIdx) => (
                  ...
                  >
                    ...
                    <div className="mb-6">
                      ...
                      <input
                        type="text"
                        className="w-full font-medium text-lg  text-slate-800 border-b placeholder:font-normal border-slate-300 pb-2 outline-none focus:border-indigo-500 transition-all bg-transparent"
                    ...
                    <div className="space-y-3">
                      {group.fields.map((f, fIdx) => (
                        <div key={fIdx} className="flex gap-3 items-center">
                          <input
                            type="text"
                            className="flex-1 p-2 bg-slate-50 border placeholder:font-normal border-slate-200 rounded text-sm font-medium text-slate-700 outline-none focus:bg-white focus:border-indigo-200 transition-all"
                      ...
                      <button
                        ...
                        className="text-[10px] font-black text-indigo-600 uppercase tracking-wide flex items-center gap-1 mt-4 hover:underline"
                      >
                        + Add Attribute Row
                      </button>
                    </div>
          ...
          {/* FOOTER ACTIONS */}
          <div className="bg-slate-900 p-8 mt-4 flex justify-end items-center gap-6">
            <button
              type="button"
              onClick={() => navigate("/products")}
              className="text-slate-400 cursor-pointer font-bold text-sm hover:text-white transition-all uppercase tracking-widest"
            >
              Discard Changes
            </button>
            <button
              type="submit"
              className="bg-indigo-600 text-white px-14 py-4 rounded-2xl font-black text-sm uppercase tracking-[0.1em] flex items-center gap-3 hover:bg-indigo-500 shadow-2xl shadow-indigo-500/20 active:scale-95 transition-all"
            >
